...
describe('Penalty Controller, (e2e)', () => {
    ...
    describe('/ POST', () => {
        it('returns a 201 and the created document', () => {
            ...
            .expect(201)
            .expect(res => {
                return expect(PenaltyArgsSchema.parse(res.body)).toBeTruthy()
            })
        })
            ...
            return req(app.getHttpServer())
                ...
                .expect(res => {
                     ...
                     return req(app.getHttpServer())
                        ...
                        .expect(200)
                        .expect(res => {
                            expect(res.body.hasOwnProperty('title')).toBeTruthy()
                        })
                })
    ...
    describe('/value GET', () => {
        it('returns the penalty value', () => {
            return req(app.getHttpServer())
                ...
                .expect(200)
                .expect(res => {
                    return expect(res.body.penalty).toEqual(envConstants.penalty)
                })
        })
