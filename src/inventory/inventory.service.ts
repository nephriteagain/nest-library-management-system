...
export class InventoryService {
    ...
    async updateInventoryItem(id : ObjectId, changes : Partial<Inventory>) : Promise<Document|null> {
        const updatedEntry = await InventorySchema.findByIdAndUpdate(id, changes, {new:true})
        return updatedEntry
    }
}
